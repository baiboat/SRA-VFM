...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--chkpt_path', required=False, default=os.path.join(working_path, 'checkpoints', DATA_NAME, 'SAM_CD_e39_OA99.31_F88.90_IoU83.99.pth') )
              ...
              if imgA.shape[0]>opt.crop_size[0] or imgA.shape[1]>opt.crop_size[1]:
                  ...
                  for idx in range(crop_num):
                      ...
                      if opt.TTA:
                          ...
                          output_hv, _, _, _ = net(tensorA_hv, tensorB_hv)
